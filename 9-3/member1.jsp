...
<link real="stylesheet"href="../css/sample.css"/>
...
<header>
	...
	<nav>
	<ul class="ulClass">
	<li id="kdhong"><a href="#kd">홍길동</a></li><li id="mrlee">이몽룡<a href="#mr"></a></li>
	...
	<%String sName=request.getParameter("sName");
	  out.println("<input id='id12'class='class3'type='text'name='sName'size='20'maxlenghth='50'value='"+sName+"'/>);
	  %></div>
